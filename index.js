...
var pluginName  = 'gulp-pandoc-any';
...
module.exports = function(opts) {
	...
	var outputFileType = opts.outputFileType;
	var outputType;
    ...
    return through.obj(function (file, enc, cb) {
		...
		if (outputFileType) {
			...
			outputFile = outputFile.replace(inputFileType, '.pdf');
		}
		...
		outputType = outputFileType && outputFileType.replace(/^\./,'');
        pdc(input, 'markdown', outputType, outputArgs, function(err, output) {
            if (err) {
